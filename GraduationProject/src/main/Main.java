...
public class Main {
	public static void main(String[] args) {
		...
		List<Tblnews> list = dataHelper.getNewsListFromLast3DaysBySubjectId("thegioi");
		...
		ArrayList<String> sentences = helperMethod.seperateSentences("Người phát ngôn Muginov nói: \"Trong quá trình thực hiện nhiệm vụ trực chiến, các trung đoàn S-400 sẽ kiểm tra khả năng tích hợp trong hệ thống phòng không hiện hành của Quân khu miền Tây theo phương hướng chiến lược Tây Bắc đồng thời thực hiện hàng loạt cuộc huấn luyện đặc biệt.\" \r\nTên lửa S-400 Triumf là phiên bản cải tiến với nhiều tính năng mạnh mẽ hơn hệ thống tên lửa S-300. \r\nHệ thống mới này có thể tiêu diệt tất cả các vật thể xuất hiện trên không trung trong tầm kiểm soát đến hơn 400 km, bao gồm các loại máy bay, tên lửa hành trình, phương tiện bay không người lái hay tên lửa đạn đạo, ở độ cao 50 km và tốc độ tối đa của mục tiêu lên đến 4.800 mét/giây./. \r\nTheo (Vietnam+) \r\nhttp://www.vietnamplus.vn/nga-dua-he-thong-ten-lua-s400-triumf-vao-nhiem-vu-truc-chien/419844.vnp \r\n");
		for (String sentence : sentences) {
			System.out.println(sentence);
		}
		ArrayList<String> words = helperMethod.seperateWords("Người phát ngôn Muginov nói: \"Trong quá trình thực hiện nhiệm vụ trực chiến, các trung đoàn S-400 sẽ kiểm tra khả năng tích hợp trong hệ thống phòng không hiện hành của Quân khu miền Tây theo phương hướng chiến lược Tây Bắc đồng thời thực hiện hàng loạt cuộc huấn luyện đặc biệt.\" \r\nTên lửa S-400 Triumf là phiên bản cải tiến với nhiều tính năng mạnh mẽ hơn hệ thống tên lửa S-300. \r\nHệ thống mới này có thể tiêu diệt tất cả các vật thể xuất hiện trên không trung trong tầm kiểm soát đến hơn 400 km, bao gồm các loại máy bay, tên lửa hành trình, phương tiện bay không người lái hay tên lửa đạn đạo, ở độ cao 50 km và tốc độ tối đa của mục tiêu lên đến 4.800 mét/giây./. \r\nTheo (Vietnam+) \r\nhttp://www.vietnamplus.vn/nga-dua-he-thong-ten-lua-s400-triumf-vao-nhiem-vu-truc-chien/419844.vnp \r\n");
